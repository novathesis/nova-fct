# Abstract: novathesis-nova-fct-v8.0.1
...
This template is a streamlined and fine-tuned version of the robust **NOVAthesis framework (v8.0.1)**, trimmed down and optimized to provide NOVA FCT students with a streamlined experience, meeting NOVA FCT's academic formatting standards without the complexity of the original multi-institution template. 

### Key Features:

* **NOVA FCT-Ready:** Pre-configured with the correct margins, cover page styles, and fonts required by NOVA FCT.
